...
describe('Fuel Savings Calculator', () => {
  describe('necessaryDataIsProvidedToCalculateSavings', () => {
    it("returns false when necessary data isn't provided", () => {
      ...
      // assert
      expect(
        calculator().necessaryDataIsProvidedToCalculateSavings(settings)
      ).toEqual(false)
    })
  ...
  describe('milesPerMonth', () => {
    it('converts a weekly timeframe to a monthly timeframe', () => {
      ...
      // act
      const milesPerMonth = calculator().calculateMilesDrivenPerMonth(
        milesPerWeek,
        'week'
      )
    ...
    it('returns a monthly timeframe untouched', () => {
      ...
      // act
      const milesPerMonthCalculated = calculator().calculateMilesDrivenPerMonth(
        milesPerMonth,
        'month'
      )
